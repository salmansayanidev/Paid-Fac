...
<main class="tracking-reporting-main">
            ...
            <div class="row justify-content-between align-items-center">
                    ...
                    <div class="full-ser-restaurants-bnner-content">
                        <nav aria-label="breadcrumb" class="breadcrumb-area">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Tracking and reporting</li>
                            </ol>
                        </nav>
                        <h2 class="banner-title text-dark-gray">Gain insights with powerful POS reporting</h2>
                        <p class="lg-para">Leverage Paidfac powerful analytics for real-time insights <br> into sales trends, key metrics, and business performance.</p>
                ...
                <div class="col-12 col-lg-5">
                    <div class="full-ser-res-bnner-img">
                        <img class="track-report-bnner-img" src="./assets/images/tracking-bnner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1500">
                    <div class="available-padifac-account-content">
                        <h2 class="section-title text-white">Take your business to the next level</h2>
                        <ul class="available-padifac-account-list p-0">
                            <li class="accordion-item active">
                                <div class="accordion-area">
                                    <button class="accordion-btn" type="button">
                                        ...
                                        <span class="accordion-btn-text">Track Sales</span>
                                    </button>
                                </div>
                                <div class="accordion-content">
                                    <p class="accordion-content-para">Stay in control of your revenue with our business tracking software and easy-to-read sales reports.</p>
                                </div>
                            </li>
                            <li class="accordion-item">
                                <div class="accordion-area">
                                    <button class="accordion-btn" type="button">
                                        <i class="fa-solid fa-plus accor-icon"></i>
                                        <span class="accordion-btn-text">Break It Down</span>
                                    </button>
                                </div>
                                <div class="accordion-content">
                                    <p class="accordion-content-para">Stay in control of your revenue with our business tracking software and easy-to-read sales reports.</p>
                            ...
                            <li class="accordion-item">
                                <div class="accordion-area">
                                    <button class="accordion-btn" type="button">
                                        <i class="fa-solid fa-plus accor-icon"></i>
                                        <span class="accordion-btn-text">Access Anytime, Anywhere</span>
                                    </button>
                                </div>
                                <div class="accordion-content">
                                    <p class="accordion-content-para">Stay in control of your revenue with our business tracking software and easy-to-read sales reports.</p>
                ...
                <div class="col-12 col-lg-6 col-xl-5" data-aos="fade-left"" data-aos-duration=" 1500">
                    <div class="available-padifac-img-area">
                        <img class="img-fluid" src="./assets/images/business-next-level-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<script src="./assets/js/tracking-reporting.js"></script>