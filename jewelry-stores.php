...
<main class="jewelry-store-main">

    <!-- jewelry store banner start -->
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-7" data-aos="fade-right" data-aos-duration="1500">
                    <div class="full-ser-restaurants-bnner-content">
                        ...
                        <h2 class="banner-title text-dark-gray">Premier POS system for jewelry stores</h2>
                ...
                <div class="col-12 col-lg-5" data-aos="fade-left" data-aos-duration="1500">
                    <div class="full-ser-res-bnner-img">
                        <img class="img-fluid" src="./assets/images/jewelry-store-bnner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- jewelry store banner end -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-9.png');">
                            <h4 class="sec-sm-title text-white">Make payments versatile</h4>
                        </div>
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-10.png');">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-9.png');">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-right" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-10.png');">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-left" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-7.png');">
...
<script src="./assets/js/jewelry-stores.js"></script>