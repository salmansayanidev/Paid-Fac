...
<main>
                        ...
                        <div class="row justify-content-end">
                            <div class="col-12 col-lg-5">
                                <div class="restaurants-POS-content-box">
                                    <p class="lg-para text-white">It extends beyond payment processing, table management, and inventory control. The leading PadiFac restaurant POS software effortlessly connects the front and back of house with your back office, empowering you to focus on delivering an exceptional customer experience.</p>
    ...
    <!-- restaurants POS section end -->

    <!-- create custom POS in minutes start  -->
    <section class="create-custom-pos-in-minutes">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-12" data-aos="fade-down" data-aos-duration="1500">
                    <div class="faq-area active">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What features does PadiFac offer specifically for restaurants?</span>
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What steps do I need to take to transition from my current solution to PadiFac?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What’s the distinction between PadiFac for Restaurants and PadiFac Point of Sale?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What’s the process for adopting the PadiFac Restaurant POS?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>How do I upgrade or downgrade my PadiFac for Restaurants plan?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What’s the setup timeline for getting started with PadiFac for Restaurants?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>Is it possible to refer other businesses to PadiFac?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>Can PadiFac for Restaurants function without an internet connection?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
