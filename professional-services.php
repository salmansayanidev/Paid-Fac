...
<main class="professional-services-main">
    <!-- professional services banner start -->
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-7" data-aos="fade-right" data-aos-duration="1500">
                    <div class="full-ser-restaurants-bnner-content">
                        ...
                        <h2 class="banner-title text-dark-gray">Flexible payment solutions for professionals</h2>
                ...
                <div class="col-12 col-xl-5" data-aos="fade-left" data-aos-duration="1500">
                    <div class="full-ser-res-bnner-img">
                        <img class="img-fluid" src="./assets/images/professional-services-bnner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- professional services banner end -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-3.png');">
                            <h4 class="sec-sm-title text-white">Get paid more ways</h4>
                        </div>
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-4.png');">
                            <h4 class="sec-sm-title text-white">Get paid more ways</h4>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-left" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-5.png');">
                        <h4 class="sec-sm-title text-white">Home & field services</h4>
                        <a class="get-started-cta justify-content-start text-white" href="home-&-field-services.php">
...
<script src=" ./assets/js/professional-services.js"></script>