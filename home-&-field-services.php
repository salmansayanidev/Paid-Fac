...
<main class="home-field-services-main">
    <!-- home field services banner start -->
                    ...
                    <div class="full-ser-restaurants-bnner-content">
                        <nav aria-label="breadcrumb" class="breadcrumb-area">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Home & field services</li>
                            </ol>
                        </nav>
                        <h2 class="banner-title text-dark-gray">The POS that drives your business forward</h2>
                        <p class="lg-para">The system that sets your services apart</p>
                        <div class="banner-cta">
                            <a href="#" class="primary-btn btn-2">
                                Get started
                            </a>
                            <a href="#" class="primary-btn btn-2 bg-transparent text-dark-gray border-dark-gray">
                                Contact sales
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xl-5" data-aos="fade-left" data-aos-duration="1500">
                    <div class="full-ser-res-bnner-img">
                        <img class="img-fluid" src="./assets/images/home-field-services-bnner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- home field services banner end -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12" data-aos="fade-left" data-aos-duration="1500">
                    <h2 class="section-title text-white">Use built-in tools to grow your business</h2>
                </div>
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-5.png');">
                            <h4 class="sec-sm-title text-white">Flexible payments</h4>
                        </div>
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-6.png');">
                            <h4 class="sec-sm-title text-white">Flexible payments</h4>
                        </div>
    ...
    <!-- create custom POS in minutes start  -->
    <section class="create-custom-pos-in-minutes bg-transparent">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="create-custom-pos-slider-btns">
                        <button class="custom-pos-slider-btn pre-arrow" type="button">
                            <i class="fa-solid fa-angle-left"></i>
                        </button>
                        <button class="custom-pos-slider-btn next-arrow" type="button">
    ...
    <!-- create custom POS in minutes end  -->
                ...
                <div class="col-12 col-lg-3 text-webkit-center" data-aos="zoom-in-right" data-aos-duration="1500">
                    <div class="pricing-radio-area">
                        <div class="pricing-radio">
                            ...
                            <label class="pricing-radio-label" for="monthly-billing">
                                <span class="pricing-radio-circle"></span>
                                <span>Monthly billing</span>
                            </label>
                        </div>
                        <div class="pricing-radio d-flex align-items-center gap-4">
                            <input type="radio" class="pricing-radio-input d-none" name="pricing_radio" id="yearly-billing">
                            <label class="pricing-radio-label" for="yearly-billing">
                                <span class="pricing-radio-circle"></span>
                                <span>Yearly billing</span>
                            </label>
                            <span class="yearly-billing-save-tag">Save 20%</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-6.png');">
                        <h4 class="sec-sm-title text-white">All services business</h4>
                        <a class="get-started-cta justify-content-start text-white" href="all-services-business.php">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-right" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-3.png');">
                        <h4 class="sec-sm-title text-white">Personal services</h4>
                        <a class="get-started-cta justify-content-start text-white" href="personal-services.php">
                            <span>Learn more</span>
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-left" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-4.png');">
                        <h4 class="sec-sm-title text-white">Professional services</h4>
                        <a class="get-started-cta justify-content-start text-white" href="professional-services.php">
                            <span>Learn more</span>
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12" data-aos="fade-down" data-aos-duration="1500">
                    <div class="faq-area active">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What is a PadiFac restaurant POS system?</span>
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What features are included in PadiFac's restaurant POS systems?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>How does PadiFac's menu management software make managing menu items easier?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>Can PadiFac's restaurant POS software integrate with my existing restaurant systems?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>How can I monitor customer orders and track preferences?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>What advantages does the PadiFac Kitchen Display System offer?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
                    ...
                    <div class="faq-area">
                        <div class="faq-top">
                            <button class="faq-btn" type="button">
                                <span>Is PadiFac suitable for various restaurant types, such as fine dining or fast food?</span>
                                <i class="fa-solid fa-plus accor-icon"></i>
                            </button>
                        </div>
                        <div class="faq-bottom">
...
<script src=" ./assets/js/home-&-field-services.js"></script>