...
<main class="book-stores-main">

    <!-- book stores banner start -->
    <section class="full-service-restaurants-banner">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                    ...
                    <div class="full-ser-restaurants-bnner-content">
                        <nav aria-label="breadcrumb" class="breadcrumb-area">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Bookstores</li>
                            </ol>
                        </nav>
                ...
                <div class="col-12 col-lg-5" data-aos="fade-left" data-aos-duration="1500">
                    <div class="full-ser-res-bnner-img">
                        <img class="img-fluid" src="./assets/images/book-store-banner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- book stores banner end -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-11.png');">
                            <h4 class="sec-sm-title text-white">Pioneering the next era in payments</h4>
                        </div>
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-12.png');">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-left" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-10.png');">
                        <h4 class="sec-sm-title text-white">For all retail stores</h4>
                        <a class="get-started-cta justify-content-start text-white" href="all-retail-stores.php">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-7.png');">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-right" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-8.png');">
...
<script src="./assets/js/book-stores.js"></script>