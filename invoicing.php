            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1500">
                    <div class="full-ser-restaurants-bnner-content">
                        ...
                        <h2 class="banner-title text-dark-gray">Email invoices for faster payments</h2>
                        <p class="lg-para">Email invoices for quick online payments by credit or debit card—often within a day. Included with PaidFac® Virtual Terminal.</p>
                ...
                <div class="col-12 col-lg-6" data-aos="fade-left" data-aos-duration="1500">
                    <div class="full-ser-res-bnner-img">
                        <img class="img-fluid invoicing-bnner-img" src="./assets/images/invoicing-banner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
