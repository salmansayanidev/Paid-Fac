...
<main class="personal-services-main">

    <!-- personal services banner start -->
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1500">
                    <div class="full-ser-restaurants-bnner-content">
                        ...
                        <h2 class="banner-title text-dark-gray">Point-of-sale system centered on service</h2>
                ...
                <div class="col-12 col-lg-6 col-xl-5" data-aos="fade-left" data-aos-duration="1500">
                    <div class="full-ser-res-bnner-img">
                        <img class="img-fluid" src="./assets/images/personal-services-banner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!-- personal services banner end -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-1.png');">
                            <h4 class="sec-sm-title text-white">Personalized payments</h4>
                        </div>
                ...
                <div class="col-12 col-lg-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    <div class="restaurants-an-edge-box">
                        <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" style="background-image: url('./assets/images/grow-your-business-img-2.png');">
                            <h4 class="sec-sm-title text-white">Sell more than just services</h4>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-right" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-4.png');">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-up" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-5.png');">
                ...
                <div class="col-12 col-lg-4">
                    <div class="gallery-slider-layer-inner crafted-enhance-hospitality-box" data-aos="fade-left" data-aos-duration="1500" style="background-image: url('./assets/images/crafted-enhance-img-6.png');">
...
<script src=" ./assets/js/personal-services.js"></script>