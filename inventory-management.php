...
<main class="inventory-management-main">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1500">
                    <div class="full-ser-restaurants-bnner-content">
                        ...
                        <h2 class="banner-title text-dark-gray">Easier inventory setup and management</h2>
                        <p class="lg-para">PaidFac’s inventory management streamlines merchandise, menus, and services for online and POS orders.</p>
                ...
                <div class="col-12 col-lg-6">
                    <div class="full-ser-res-bnner-img">
                        <img class="inven-management-bnner-img" src="./assets/images/inventory-management-bnner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1500">
                    <div class="available-padifac-account-content">
                        <h2 class="section-title text-white">Monitor your business inventory</h2>
                        <ul class="available-padifac-account-list p-0">
                            <li class="accordion-item active">
                                <div class="accordion-area">
                                    <button class="accordion-btn" type="button">
                                        ...
                                        <span class="accordion-btn-text">Improved Accuracy</span>
                                    </button>
                                </div>
                                <div class="accordion-content">
                                    <p class="accordion-content-para">Track available items and order only what’s needed to meet customer demand.</p>
                                </div>
                            </li>
                            <li class="accordion-item">
                                <div class="accordion-area">
                                    <button class="accordion-btn" type="button">
                                        <i class="fa-solid fa-plus accor-icon"></i>
                                        <span class="accordion-btn-text">Deeper Insights</span>
                                    </button>
                                </div>
                                <div class="accordion-content">
                                    <p class="accordion-content-para">Track available items and order only what’s needed to meet customer demand.</p>
                            ...
                            <li class="accordion-item">
                                <div class="accordion-area">
                                    <button class="accordion-btn" type="button">
                                        <i class="fa-solid fa-plus accor-icon"></i>
                                        <span class="accordion-btn-text">Save Time</span>
                                    </button>
                                </div>
                                <div class="accordion-content">
                                    <p class="accordion-content-para">Track available items and order only what’s needed to meet customer demand.</p>
                ...
                <div class="col-12 col-lg-6 col-xl-5" data-aos="fade-left"" data-aos-duration=" 1500">
                    <div class="available-padifac-img-area">
                        <img class="img-fluid" src="./assets/images/business-inventory-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
